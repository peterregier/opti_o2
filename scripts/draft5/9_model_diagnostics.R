...
all_models %>% 
  ...
  labs(x = "Predictors included (based on driver)", y = "R2") + 
  theme(axis.text.x = element_text(angle = 45, vjust = 1, hjust=1))
ggsave("figures/S1_r2_by_model_input_type.png", width = 6, height = 4.5)
...
ggplot(wn_stats, aes(fct_reorder(pred2, mean), mean)) + 
  ...
  theme(axis.text.x = element_text(angle = 45, vjust = 1, hjust=1))
ggsave("figures/S2_feature_importance_white_noise.png", width = 8, height = 5)
